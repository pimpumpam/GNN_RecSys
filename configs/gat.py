...
class CfgModel:
    ...
    gnn_layer = {
        ...
        'architecture': [
            # args: [in_dim, out_dim, num_heads, feat_drop, attn_drop, negative_slope, residual, activation]
            ['dglnn.GATConv', [200, 100, 3, 0.0, 0.0, 0.2, False, 'F.relu']],
            ['dglnn.GATConv', [300, 100, 3, 0.0, 0.0, 0.2, False, 'F.relu']],
            ['dglnn.GATConv', [300, 50, 3]]
        ]
    }
